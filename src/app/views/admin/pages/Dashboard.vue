...
import WidgetsStatsA from '@/app/views/admin/pages/widgets/WidgetsStatsTypeA.vue'
import WidgetsStatsD from '@/app/views/admin/pages/widgets/WidgetsStatsTypeD.vue'
